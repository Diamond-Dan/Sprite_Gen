...
images_blueprint = Blueprint(
    "images", __name__, static_folder="images", static_url_path="/images"
)
app.register_blueprint(images_blueprint)

# Create a blueprint for the second static folder
gifs_blueprint = Blueprint(
    "gifs", __name__, static_folder="gifs", static_url_path="/gifs"
)
...
def generate_random_images():
    ...
    filename, filename_2, gif_loc_1, gif_loc_2 = sprite_micro_gen.main(
        start_x,
        start_y,
        frames,
        seed,
